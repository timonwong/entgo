...
var schemaGraph = func() *sqlgraph.Schema {
	graph := &sqlgraph.Schema{Nodes: make([]*sqlgraph.Node, 0, 14)}
...
// EntQL returns an entql.Where implementation to apply filters on the CardQuery builder.
func (cq *CardQuery) EntQL() *CardFilter {
...
func (f *CardFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.Card(func(s *sql.Selector) {
...
func (f *CardFilter) WhereHasOwnerWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("owner", p...))
}
...
func (f *CardFilter) WhereHasSpecWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("spec", p...))
}

// EntQL returns an entql.Where implementation to apply filters on the CommentQuery builder.
func (cq *CommentQuery) EntQL() *CommentFilter {
...
func (f *CommentFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.Comment(func(s *sql.Selector) {
...
// EntQL returns an entql.Where implementation to apply filters on the FieldTypeQuery builder.
func (ftq *FieldTypeQuery) EntQL() *FieldTypeFilter {
...
func (f *FieldTypeFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.FieldType(func(s *sql.Selector) {
...
// EntQL returns an entql.Where implementation to apply filters on the FileQuery builder.
func (fq *FileQuery) EntQL() *FileFilter {
...
func (f *FileFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.File(func(s *sql.Selector) {
...
// WhereHasOwnerWith applies a predicate to check if query has an edge owner with a given conditions (other predicates).
func (f *FileFilter) WhereHasOwnerWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("owner", p...))
}
...
func (f *FileFilter) WhereHasTypeWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("type", p...))
}
...
func (f *FileFilter) WhereHasFieldWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("field", p...))
}

// EntQL returns an entql.Where implementation to apply filters on the FileTypeQuery builder.
func (ftq *FileTypeQuery) EntQL() *FileTypeFilter {
...
func (f *FileTypeFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.FileType(func(s *sql.Selector) {
...
func (f *FileTypeFilter) WhereHasFilesWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("files", p...))
}

// EntQL returns an entql.Where implementation to apply filters on the GoodsQuery builder.
func (gq *GoodsQuery) EntQL() *GoodsFilter {
...
func (f *GoodsFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.Goods(func(s *sql.Selector) {
...
// EntQL returns an entql.Where implementation to apply filters on the GroupQuery builder.
func (gq *GroupQuery) EntQL() *GroupFilter {
...
func (f *GroupFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.Group(func(s *sql.Selector) {
...
// WhereHasFilesWith applies a predicate to check if query has an edge files with a given conditions (other predicates).
func (f *GroupFilter) WhereHasFilesWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("files", p...))
}
...
func (f *GroupFilter) WhereHasBlockedWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("blocked", p...))
}
...
func (f *GroupFilter) WhereHasUsersWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("users", p...))
}
...
func (f *GroupFilter) WhereHasInfoWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("info", p...))
}

// EntQL returns an entql.Where implementation to apply filters on the GroupInfoQuery builder.
func (giq *GroupInfoQuery) EntQL() *GroupInfoFilter {
...
func (f *GroupInfoFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.GroupInfo(func(s *sql.Selector) {
...
func (f *GroupInfoFilter) WhereHasGroupsWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("groups", p...))
}

// EntQL returns an entql.Where implementation to apply filters on the ItemQuery builder.
func (iq *ItemQuery) EntQL() *ItemFilter {
...
func (f *ItemFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.Item(func(s *sql.Selector) {
...
// EntQL returns an entql.Where implementation to apply filters on the NodeQuery builder.
func (nq *NodeQuery) EntQL() *NodeFilter {
...
func (f *NodeFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.Node(func(s *sql.Selector) {
...
func (f *NodeFilter) WhereHasPrevWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("prev", p...))
}
...
func (f *NodeFilter) WhereHasNextWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("next", p...))
}

// EntQL returns an entql.Where implementation to apply filters on the PetQuery builder.
func (pq *PetQuery) EntQL() *PetFilter {
	return &PetFilter{pq}
}
...
func (f *PetFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.Pet(func(s *sql.Selector) {
...
func (f *PetFilter) WhereHasTeamWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("team", p...))
}
...
// WhereHasOwnerWith applies a predicate to check if query has an edge owner with a given conditions (other predicates).
func (f *PetFilter) WhereHasOwnerWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("owner", p...))
}

// EntQL returns an entql.Where implementation to apply filters on the SpecQuery builder.
func (sq *SpecQuery) EntQL() *SpecFilter {
...
func (f *SpecFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.Spec(func(s *sql.Selector) {
...
func (f *SpecFilter) WhereHasCardWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("card", p...))
}

// EntQL returns an entql.Where implementation to apply filters on the TaskQuery builder.
func (tq *TaskQuery) EntQL() *TaskFilter {
...
func (f *TaskFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.Task(func(s *sql.Selector) {
...
// EntQL returns an entql.Where implementation to apply filters on the UserQuery builder.
func (uq *UserQuery) EntQL() *UserFilter {
...
func (f *UserFilter) Where(p entql.P) {
	f.predicates = append(f.predicates, predicate.User(func(s *sql.Selector) {
...
// WhereHasCardWith applies a predicate to check if query has an edge card with a given conditions (other predicates).
func (f *UserFilter) WhereHasCardWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("card", p...))
}
...
func (f *UserFilter) WhereHasPetsWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("pets", p...))
}
...
// WhereHasFilesWith applies a predicate to check if query has an edge files with a given conditions (other predicates).
func (f *UserFilter) WhereHasFilesWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("files", p...))
}
...
// WhereHasGroupsWith applies a predicate to check if query has an edge groups with a given conditions (other predicates).
func (f *UserFilter) WhereHasGroupsWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("groups", p...))
}
...
func (f *UserFilter) WhereHasFriendsWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("friends", p...))
}
...
func (f *UserFilter) WhereHasFollowersWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("followers", p...))
}
...
func (f *UserFilter) WhereHasFollowingWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("following", p...))
}
...
// WhereHasTeamWith applies a predicate to check if query has an edge team with a given conditions (other predicates).
func (f *UserFilter) WhereHasTeamWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("team", p...))
}
...
func (f *UserFilter) WhereHasSpouseWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("spouse", p...))
}
...
func (f *UserFilter) WhereHasChildrenWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("children", p...))
}
...
func (f *UserFilter) WhereHasParentWith(p ...entql.P) {
	f.Where(entql.HasEdgeWith("parent", p...))
}
